<div class="row">
    <div class="span4">
        <div id="block_admin">
            ...
            <ul>
                <li><a href="index.php?action=section_data_edit">Редактировать section_data</a></li>
            ...
            <ul>
                ...
                <li><a href="index.php?action=mission_edit">Редактировать миссию</a></li>
            </ul>
            ...
            <h4>Редактирование страницы "FAQ"</h4>
            <ul>
